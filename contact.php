			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="homepage.html">Home</a>

								</li>
								<li><a href="homepage.html">Services</a></li>
								<li><a href="homepage.html">Gallery</a>

								</li>
								<li><a href="homepage.html">Testimony</a>

								</li>

								<li><a href="homepage.html">Project</a>
